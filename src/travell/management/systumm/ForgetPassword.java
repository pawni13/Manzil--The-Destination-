...
public class ForgetPassword extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()== search){
            try{
                String query = "select * from acccount where username= '"+tfusername.getText()+"'";
                Conn c = new Conn();
            ...
            try{
                String query = "select * from acccount where answer= '"+tfanswer.getText()+"'AND username = '"+tfusername.getText()+"'";
                Conn c = new Conn();
