...
public class CheckPackage extends JFrame{
    CheckPackage(){
       ...
       String[] package1 = new String[]{"GOLD PACKAGE","6 days and 7 Nights", "Airport Assistance", "City Tour", "Welcome drinks on Arrival", "Daily Buffet", "Full Day 3 Island Cruise", "English Speaking Guide", "BOOK NOW", "Summer Special", "Rs 12000/-","package1.jpg"};
