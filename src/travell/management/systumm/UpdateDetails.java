...
public class UpdateDetails extends JFrame implements ActionListener{
    ...
    UpdateDetails(String username){
       ...
       tfgender = new JTextField();
        ...
        ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("images/updatee.jpg"));
       ...
       try{
           Conn c = new Conn();
         ResultSet rs =  c.s.executeQuery("select * from customeer where username = username" );
         while(rs.next()){
    ...
    public void actionPerformed(ActionEvent ae){
       if(ae.getSource()== update) {
           ...
           try{
              Conn c= new Conn();
               String query = "update customeer set username='"+username+"',id='"+id+"',number='"+number+"',name='"+name+"',gender='"+gender+"',country='"+country+"',address='"+address+"',email='"+email+"',phone='"+phone+"'";
